...
#### :bug: Bug Fix
* `ember-launch-darkly`
  * [#626](https://github.com/adopted-ember-addons/ember-launch-darkly/pull/626) Make Context more generic ([@RobbieTheWagner](https://github.com/RobbieTheWagner))
...
#### :bug: Bug Fix
* `ember-launch-darkly`
  * [#622](https://github.com/adopted-ember-addons/ember-launch-darkly/pull/622) Try again to fix generic types ([@RobbieTheWagner](https://github.com/RobbieTheWagner))
...
* ember-launch-darkly 5.2.1 (patch)

#### :bug: Bug Fix
* `ember-launch-darkly`
  * [#619](https://github.com/adopted-ember-addons/ember-launch-darkly/pull/619) Make variation generic ([@RobbieTheWagner](https://github.com/RobbieTheWagner))
